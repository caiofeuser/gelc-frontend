...
export default function Projects() {
  ...
  return (
    <React.Fragment>
      <Header projects />
      <main id="projects-page-main" onClick={() => console.log(projects)}>
        <Container>
          <h1 className="text-center my-5">Projetos</h1>
          <p className="text-center text-muted mt-2 mb-5">
            Conheça os projetos desenvolvidos pelo nosso grupo.
          </p>
          <Row className="my-2">
            <Col lg={9}></Col>
            <Col lg={3}>
              <PublicSearchField onSearch={searchProject} />
            </Col>
          </Row>
