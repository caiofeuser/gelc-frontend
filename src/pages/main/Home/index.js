...
function Home() {
    ...
    async function loadMoreParticipants() {
        ...
        if(team.hasNextPage) {
            ...
            let participants = (await api.get('/participant?public=true',{params})).data;
    ...
    return (
        <React.Fragment>
            ...
            <main>
                ...
                <TeamSection participants={team?.docs} key={team.docs?team?.docs.length:0} loadMoreParticipants={loadMoreParticipants}/>
                <PortfolioSection awards={info?.awardsNumber} projects={info?.projectsNumber} articles={info?.publicationsNumber}/>
            </main>
