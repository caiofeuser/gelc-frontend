      ...
      <main id="downloads-page-main">
        <Container>
          ...
          <p className="text-center text-muted mt-2 mb-5">
            Realize <em>Downloads</em> de arquivos compartilhados.
          </p>
          <Row className="my-2">
            <Col lg={9}></Col>
            <Col lg={3}>
              <PublicSearchField onSearch={searchDownlaods} />
            </Col>
          </Row>
          <Row>
            <Col>
              {loading ? (
                ...
                <PublicDownloadsList downloads={downloads} />
              )}
            </Col>
          </Row>
          <Row>
